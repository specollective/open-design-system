...
const NAMESPACE = 'spec-ods';
const BUILD = /* spec-ods */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: false, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: false, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: false };
...
const createElm = (e, t, o, n) => {
 ...
 let r;
 null !== a ? (r = o["s-cr"]) ? r.parentNode.textContent = a : e.$text$ !== a && (o.data = a) : (("slot" === l || updateElement(e, t)), 
...
const accordionButtonScss = "/*!@**/*.sc-accordion-button {\n    font-family: 'Lato', sans-serif;\n}\n\n/*!@.container*/.container.sc-accordion-button {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center\n}\n\n/*!@.accordion*/.accordion.sc-accordion-button {\n    cursor: pointer;\n    padding: 18px;\n    text-align: left;\n    border-radius: 20px;\n    font-size: 1.2rem;\n    font-weight: bold;\n    outline: 0;\n    span {\n        float: right;\n    }\n}\n\n /*!@.open*/.open.sc-accordion-button {\n    display: block;\n    height: auto;\n    border-radius: 20px;\n    border: 0.5px solid rgb(199, 197, 197);\n    width: 200px;\n }\n\n /*!@p*/p.sc-accordion-button {\n    padding: 18px;\n }\n\n /*!@.close*/.close.sc-accordion-button {\n    display: none;\n }";
...
class AccordionButton {
  ...
  toggleComponent() {
    ...
    this.clicked.emit({ visible: this.toggle });
  }
  render() {
    return (hAsync("div", null, hAsync("button", { class: "accordion", style: {
        width: this.width,
        backgroundColor: this.color,
      }, onClick: () => this.toggleComponent() }, this.label, this.toggle ? hAsync("span", null, "\u25B2") : hAsync("span", null, "\u25BC")), hAsync("div", { class: `content-box ${this.toggle ? 'open' : 'close'}`, style: { width: this.width } }, hAsync("p", null, this.description))));
  }
  static get style() { return accordionButtonScss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "accordion-button",
    "$members$": {
      "label": [1],
      "description": [1],
      "width": [1],
...
const plainButtonScss = "/*!@.plainjane*/";
...
class PlainButton {
  ...
  render() {
    return (hAsync("div", null, hAsync("button", { class: "plainjane" }, hAsync("slot", null))));
  }
  static get style() { return plainButtonScss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "plain-button",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
